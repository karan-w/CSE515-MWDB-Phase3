...
class Task3:
    ...
    def execute(self):
        ...
        class_labels = task_helper.extract_class_labels(training_images, IMAGE_ID)
        ...
        # equivalent to y in classical machine learning - np.ndarray (4800 * 1)
        true_class_labels = task_helper.extract_class_labels(test_images, IMAGE_ID)
...
logger = logging.getLogger(Task3.__name__)

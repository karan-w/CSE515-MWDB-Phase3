...
python Task5.py --b %b% --feature_model %model% --t %t%  --k %k_value% --images_folder_path %images_folder_path%  --latent_semantics_file %latent_semantics_file% --output_folder_path %output_folder_path% --query_image_path %query_image_path% --dimensionality_reduction_technique %dimensionality_reduction_technique%